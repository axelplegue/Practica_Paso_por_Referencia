...
void enemyAttack(string enemyName, int& enemyDamage) {
...
int main()
{
    ...
    while (heroIsAlive && (enemyIsAlive1 || enemyIsAlive2)) {
        ...
        if (enemyChoosed == 1) {
            ...
            enemyHP1 = heroAttackEnemy(enemyName1, heroDamage, enemyHP1);
            checkEnemyStatus(enemyName1, enemyHP1, enemyIsAlive1);
        }
        else {
            //ATACAMOS AL ENEMIGO 2
            enemyHP2 = heroAttackEnemy(enemyName2, heroDamage, enemyHP2);
